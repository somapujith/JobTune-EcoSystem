...
/**
 * Worker port (leaf1 slice) of backend/src/services/resumeConsistencyService.js.
 ...
 * same public API for the service container (registry key: resumeConsistencyService). The
...
function createResumeConsistencyService() {
  return { checkConsistency, norm, skillSet, projectSet, experienceList };
}
