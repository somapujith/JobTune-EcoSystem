    ...
    <div className="page-container">
      <div className="mb-12">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-blue-100 dark:bg-blue-900/30 mb-4">
          <span className="material-symbols-outlined text-blue-600 dark:text-blue-400 text-3xl" style={{ fontVariationSettings: "'FILL' 0" }}>mail</span>
        </div>
      ...
      {/* How It Works Guide */}
      <div className="mb-12 card rounded-2xl p-8">
        ...
        <form onSubmit={handleGenerate} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
              type="submit"
              disabled={loading}
              className="btn-gradient bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 flex items-center justify-center gap-3"
            >
              {loading ? (
                <>
          ...
          {letter ? (
            <div className="card rounded-2xl p-8 h-full flex flex-col">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Generated Letter</h3>
            ...
            <div className="card rounded-2xl p-8 h-full flex items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-700">
